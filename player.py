...
rootpath = "C:\\Users\supre\Music\good_kid,_m.A.A.d_city"
pattern = "*.mp3"
...
listBox = tk.Listbox(canvas, fg = 'cyan', bg = 'black', width = 100, font = ('poppins', 16))
listBox.pack(padx=15, pady=15)

label = tk.Label(canvas, text = "", bg = 'black', fg = 'yellow', font = ('poppins', 20))
label.pack(pady=15)
